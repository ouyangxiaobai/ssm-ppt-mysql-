...
<html lang="en">
				...
				<div class="container-fluid">
					<a href="#" class="brand">
						<small style="font-size: 26px; font-weight: bold;line-height: 40px;">
							酒店客房管理系统  
							<span style="font-size: 17px;">Hotel Management System</span>
						</small>
					</a>
    ...
    padding-top: 14px;
    color: #fff;">
				    		欢迎您：<span class="dl-log-user">${user.userName }</span><a href="<%=request.getContextPath()%>/Login/quit.do" title="退出系统" class="dl-log-quit" style="color: #fff;
